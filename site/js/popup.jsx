...
export default class Popup extends React.Component {
  ...
  render(){
    return <div className={this.state.isClosed ? 'popup closed' : 'popup'}>
        ...
        <p id='tekstThree'><br /><span id="bigger">Tu i Teraz</span> poznaj i usłysz tę wielką chwilę naszej historii. Klikaj w hotspoty aby odkryć kulisy bitwy pod Grunwaldem. </p>
